-- The nudge asks "can she submit?", never "what is her status?".
--
-- Yesterday's version excluded approved profiles, leaning on an invariant
-- ("approved implies complete") that stopped holding the moment incomplete
-- profiles were published and approved by hand. An approved nanny with no
-- photo is findable and still needs to hear what is missing; the email copy
-- for exactly her has existed since f33a1d3.
